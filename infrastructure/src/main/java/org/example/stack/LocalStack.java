...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App app, final String id, final StackProps props) {
        ...
        CfnHealthCheck authDbHealthCheck = createDbHealthCheck(authServiceDb, "auth-db-health-check");
        CfnHealthCheck patientDbHealthCheck = createDbHealthCheck(patientServiceDb, "patient-health-check");
